...
mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/vlukss/Premium/main/vps.conf"
sleep 1
wget -q -O xraymode.sh https://raw.githubusercontent.com/takbebeh/Premium/main/xraymode.sh && chmod +x xraymode.sh && ./xraymode.sh
sleep 1
wget -q -O /etc/xray/config.json "https://raw.githubusercontent.com/vlukss/Premium/main/conf/config.json"
