...
cd
mkdir /root/zoonk
wget -q -O /usr/bin/updatsc "https://raw.githubusercontent.com/vlukss/Premium/main/update.sh"
wget -q -O /usr/bin/xp "https://raw.githubusercontent.com/vlukss/Premium/main/xp.sh"
cd /root/zoonk
wget https://raw.githubusercontent.com/vlukss/Premium/main/zonk.zip >/dev/null 2>&1
7z e -pvlukssangatganteng zonk.zip
rm -f zonk.zip
chmod +x *
mv * /usr/bin/
cd
